...
/************************************************************************
  ...
  10.4: SORTED SEARCH, NO SIZE
	...
	method. It does, however, have an elementAt ( i) method that returns
	the element at index i in 0( 1) time. If i is beyond the bounds of the
	data structure, it returns -1. (For this reason, the data structure
...
/************************************************************************
  ...
  10.6: SORT BIG FILE
	...
	Imagine you have a 20 GB file with one string per line. Explain how
...
/************************************************************************
  ...
  10.7: MISSING INT
	...
	Given an input file with four billion non-negative integers, provide
	an algorithm to generate an integer that is not contained in the file. 
...
/************************************************************************
  ...
  10.10: RANK FROM STREAM
	...
	to be able to look up the rank of a numberx (the number of values less
...
/************************************************************************
  ...
  10.11: PEAKS AND VALLEYS
	...
	or equal to the adjacent integers and a "valley" is an element which is
	less than or equal to the adjacent integers. For example, in the array
	{5, 8, 6, 2, 3, 4, 6}, {8, 6} are peaks and {5, 2} are valleys. Given
	an array of integers, sort the array into an alternating sequence of
	peaks and valleys.
