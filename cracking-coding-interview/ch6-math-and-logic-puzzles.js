/************************************************************************
  ...
  6.1: THE HEAVY PILL
	...
	has pills of weight 1.1 grams. Given a scale that provides an exact
	measurement, how would you find the heavy bottle? You can only use the
	scale once.
...
/************************************************************************
  ...
  6.3: DOMINOS
	...
	There is an 8x8 chessboard in which two diagonally opposite corners
	...
	entire board? Prove your answer (by providing an example or showing why
	it's impossible).
...
/************************************************************************
  ...
  6.4: ANTS ON A TRIANGLE
	...
	walking on the sides of the triangle? Assume that each ant randomly
	picks a direction, with either direction being equally likely to be
	chosen, and that they walk at the same speed.
...
/************************************************************************
  ...
  6.5: JUGS OF WATER
	...
	(but no measuring cups). How would you come up with exactly four quarts
	of water? Note that the jugs are oddly shaped, such that filling up
...
/************************************************************************
  ...
  6.7: PAIRWISE SWAP
	...
	desperately concerned about the birth rate. Therefore, she decrees that
	all families should ensure that they have one girl or else they face
	massive fines. If all families abide by this policy-that is, they have
	continue to have children until they have one girl, at which point they
	...
	pregnancy is equal.) Solve this out logically and then write a computer
	simulation of it.
...
/************************************************************************
  ...
  6.10: POISON
	...
	You have 1000 bottles of soda, and exactly one is poisoned. You have
	10 test strips which can be used to detect poison. A single drop of
	...
	as many times as you'd like (as long as the results are negative).
