...
/************************************************************************
  ...
  16.7: NUMBER MAX
	...
	Write a method that finds the maximum of two numbers. You should not
...
/************************************************************************
  ...
  16.9: OPERATIONS
	...
	operations for integers. The results of all of these are integers. Use
...
/************************************************************************
  ...
  16.10: LIVING PEOPLE
	...
	method to compute the year with the most number of people alive. You
	...
	For example, Person (birth = 1908, death = 1909) is included in the
...
/************************************************************************
  ...
  16.13: BISECT SQUARES
	...
	cut these two squares in half. Assume that the top and the bottom sides
...
/************************************************************************
  ...
  16.15: MASTER MIND
	...
	example, guess Y RGB. When you guess the correct color for the correct
	slot, you get a "hit:' If you guess a color that exists but is in the
	wrong slot, you get a "pseudo-hit:' Note that a slot that is a hit can
	never count as a pseudo-hit.
	
	For example, if the actual solution is RGBY and you guess GGRR, you
	have one hit and one pseudo-hit. Write a method that, given a guess
...
/************************************************************************
  ...
  16.18: PATTERN MATCHING
	...
	aabab (where cat is a and go is b). It also matches patterns like a,
	ab, and b.
...
/************************************************************************
  ...
  16.19: POND SIZES
	...
	at that location represents the height above sea level. A value of zero
	indicates water. A pond is a region of water connected vertically,
	horizontally, or diagonally. The size of the pond is the total number
	of connected water cells. Write a method to compute the sizes of all
	ponds in the matrix.
...
/************************************************************************
  ...
  16.20: T9
	...
	provide a list of words that matched these numbers. Each digit mapped
	to a set of O - 4 letters. Implement an algorithm to return a list of
	matching words, given a sequence of digits. You are provided a list of
	valid words (provided in whatever data structure you'd like). The
...
/************************************************************************
  ...
  16.23: RAND7 FROM RAND5
	...
	generates a random number between O and 4 (inclusive), write a method
	that generates a random number between O and 6 (inclusive).
...
/************************************************************************
  ...
  16.25: LRU CACHE
	...
	you to insert and retrieve a value associated with a particular key)
	and be initialized with a max size. When it is full, it should evict
